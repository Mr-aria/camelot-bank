...
def get_account_by_user_id(user_id):
    """دریافت حساب بانکی با آیدی کاربر"""
    conn = get_db()
    c = conn.cursor()
...
def get_account_by_number(acc_num):
    """دریافت حساب بانکی با شماره حساب"""
    conn = get_db()
    c = conn.cursor()
...
def get_balance(account_number):
    """دریافت موجودی حساب با شماره حساب"""
    conn = get_db()
    c = conn.cursor()
